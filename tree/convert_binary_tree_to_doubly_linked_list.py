...
class BinaryTreeToDLL:
    def __init__(self):
        ...
        # convert_bt_to_dll() will convert the given binary tree to corresponding doubly linked list

    def convert_bt_to_dll(self, node):
        # Checks whether node is None
        if node is None:
            return

            # Convert left subtree to doubly linked list
        self.convert_bt_to_dll(node.left)
        ...
        self.convert_bt_to_dll(node.right)
